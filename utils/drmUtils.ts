import type { DRMConfiguration, FairPlayKeySystemConfiguration, KeySystemConfiguration } from 'react-native-theoplayer';
...
function appendQueryParameters(
  ...
  keySystemConfig: KeySystemConfiguration | undefined,
): string {
 ...
 */
export function getFairplayLicenseAcquisitionURL(config: DRMConfiguration & { fairplay?: FairPlayKeySystemConfiguration }, defaultUrl: string): string {
