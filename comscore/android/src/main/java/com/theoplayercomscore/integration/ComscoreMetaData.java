...
public class ComscoreMetaData {
  ...
  public ContentMetadata toComscoreContentMetadata() {
    ...
    if (dateOfProduction != null)
      cm.dateOfProduction(dateOfProduction.getYear(), dateOfProduction.getMonth(), dateOfProduction.getDay());
    if (timeOfProduction != null)
      cm.timeOfProduction(timeOfProduction.getHours(), timeOfProduction.getMinutes());
    if (dateOfTvAiring != null)
      cm.dateOfTvAiring(dateOfTvAiring.getYear(), dateOfTvAiring.getMonth(), dateOfTvAiring.getDay());
    if (timeOfTvAiring != null)
      cm.timeOfTvAiring(timeOfTvAiring.getHours(), timeOfTvAiring.getMinutes());
    if (dateOfDigitalAiring != null)
      cm.dateOfDigitalAiring(dateOfDigitalAiring.getYear(), dateOfDigitalAiring.getMonth(), dateOfDigitalAiring.getDay());
    if (timeOfDigitalAiring != null)
      cm.timeOfDigitalAiring(timeOfDigitalAiring.getHours(), timeOfDigitalAiring.getMinutes());
    ...
    if (deliverySubscriptionType != null)
      cm.deliverySubscriptionType(deliverySubscriptionType.toComscore());
    if (deliveryComposition != null) cm.deliveryComposition(deliveryComposition.toComscore());
    if (deliveryAdvertisementCapability != null)
      cm.deliveryAdvertisementCapability(deliveryAdvertisementCapability.toComscore());
    ...
    if (videoDimension != null)
      cm.videoDimensions(videoDimension.getWidth(), videoDimension.getHeight());
