...
export function useNpaw(config: NpawConnectorConfig): [RefObject<NpawConnector | undefined>, (player: THEOplayer | undefined) => void] {
  const connector = useRef<NpawConnector | undefined>(undefined);
